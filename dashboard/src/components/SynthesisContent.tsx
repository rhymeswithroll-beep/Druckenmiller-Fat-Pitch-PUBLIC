  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="panel p-4"><div className="text-[10px] text-gray-500 tracking-wider uppercase mb-1">Breadth</div>{breadth?.pct_above_200dma != null ? <div className={`text-xl font-display font-bold ${breadth.pct_above_200dma > 50 ? 'text-emerald-600' : 'text-rose-600'}`}>{breadth.pct_above_200dma.toFixed(1)}%</div> : <div className="text-gray-500 text-[10px]">N/A</div>}</div>
