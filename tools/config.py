...
CLAUDE_MODEL = "claude-haiku-4-5-20251001"         # Fast classification / extraction
CLAUDE_SONNET_MODEL = "claude-sonnet-4-5"          # Heavier reasoning tasks (intelligence reports, devil's advocate, memos)
...
CUSTOM_TICKERS: dict[str, tuple[str, str, str]] = {
    ...
    "MTH":  ("Meritage Homes Corporation", "Consumer Cyclical", "Residential Construction"),
}
VIX_TICKER = "^VIX"
VIX3M_TICKER = "^VIX3M"
